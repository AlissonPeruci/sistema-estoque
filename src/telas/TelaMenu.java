...
public class TelaMenu extends javax.swing.JFrame {
    ...
    private void chavear() {
        ...
        itmCadastrarFuncionarios.setVisible(false); //desabilita a visibiliade par o usuario caixa
        itmAlterarFuncionarios.setVisible(false);
        itmExcluirFuncionarios.setVisible(false);
        itmRelatorioFuncionarios.setVisible(false);
    ...
    private void initComponents() {
        ...
        btnSalvarCadastroProduto.setBounds(20, 300, 63, 23);
        ...
        btnConsultarProduto.setBounds(90, 300, 90, 23);
        ...
        btnExcluirProduto.setBounds(190, 300, 80, 23);
        ...
        btnAlterarProduto.setBounds(280, 300, 100, 23);
        ...
        jblOutrosRelatorios.setBounds(390, 300, 130, 23);
        ...
        jLabel1.setBounds(20, 210, 70, 14);

        getContentPane().add(pnlCadastrarProdutos);
        pnlCadastrarProdutos.setBounds(10, 0, 600, 340);
    ...
    private void btnAlterarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarProdutoActionPerformed
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            conexao = DriverManager.getConnection("jdbc:mysql://localhost:3307/bancoestoque", "root", "123456");
            st = conexao.prepareStatement("UPDATE cadastros SET nome =?, marca =?, preco=? WHERE codigo=?");
            st.setString(1, txtPainelNome.getText());
            st.setString(2, txtPainelMarca.getText());
            st.setString(3, txtPainelPreco.getText());
            st.setString(4, txtPainelCodigo.getText());
